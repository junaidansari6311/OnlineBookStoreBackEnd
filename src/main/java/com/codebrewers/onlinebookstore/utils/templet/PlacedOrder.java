...
public class PlacedOrder {
    ...
    public String getHeader(CartDetails cart, Integer orderID, Double totalPrice, List<BookCartDetails> bookDetails) {
        return  "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN'\n"  +
                ...
                "                                                                                                    <td style=\"text-align: right;\"><span style=\"font-size: 18px; line-height: 200%;\"><strong> RS. "+totalPrice+"</strong></span></td>\n" +
                "                                                                                                </tr>\n" +
                "                                                                                            </tbody>\n" +
                "                                                                                        </table>\n" +
                "                                                                                    </td>\n" +
