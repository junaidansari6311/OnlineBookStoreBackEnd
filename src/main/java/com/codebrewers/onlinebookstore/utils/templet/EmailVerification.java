...
public class EmailVerification {
    ...
    public String getHeader(String token) {
        return "<!doctype html>\n" +
                ...
                "                        <h3>You are just one step away to access the features of CB's Book Store.<br>Click on the below button to verify your email address.</h3><br>\n" +
                ...
                "                                  <tbody>\n" +
                "                                    <tr>\n" +
                "                                      <td> <a href="+token+">confirm email</a> </td>\n" +
                "                                    </tr>\n" +
                "                                  </tbody>\n" +
                "                                </table>\n" +
                "                              </td>\n" +
